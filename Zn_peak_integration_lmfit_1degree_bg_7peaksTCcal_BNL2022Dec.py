...
def single_peak_fit(x,y,hint,scan_i): 
    ...
    if scan_i>=0: 
        ...
        params['center'].min = hint['center']-0.03
        params['center'].max = hint['center']+0.03
    if scan_i>=1: 
...
# set initial parameter values and bounds
    if scan_i >= 0:
        ...
        params['center1'].min = hint['center1']-0.03
        params['center1'].max = hint['center1']+0.03
        params['center2'].min = hint['center2']-0.03
        params['center2'].max = hint['center2']+0.03
